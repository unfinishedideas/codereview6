import { DoctorB } from './../src/doctor.js';
...
describe('Doctor', () => {
  ...
  beforeEach(function() {
    practice1 = new Practice("Jimmity MD 1", "123 Fake St", "1112223333", true);
    ...
    newDoctor = new Doctor("Jimmity","Jimson", practiceList);
  ...
  test('vetPractices() should detect duplicate practices and remove them', () => {
